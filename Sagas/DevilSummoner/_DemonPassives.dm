...
/proc/InitDemonPassives()
	DEMON_PASSIVE_DB = list()

	// ===== STAT BOOSTS =====
	DEMON_PASSIVE_DB["Phys Boost"]   = new /datum/demon_passive("Phys Boost",  "Demon Str x1.5.",                              "stat", "Phys")
	DEMON_PASSIVE_DB["Phys Amp"]     = new /datum/demon_passive("Phys Amp",    "Demon Str x2.0.",                              "stat", "Phys")
	DEMON_PASSIVE_DB["Phys Up"]      = new /datum/demon_passive("Phys Up",     "Demon Str x1.2.",                              "stat", "Phys")
	DEMON_PASSIVE_DB["Fire Boost"]   = new /datum/demon_passive("Fire Boost",  "+20% damage to demon's fire attacks.",         "stat", "Fire")
	DEMON_PASSIVE_DB["Fire Amp"]     = new /datum/demon_passive("Fire Amp",    "+50% damage to demon's fire attacks.",         "stat", "Fire")
	DEMON_PASSIVE_DB["Ice Boost"]    = new /datum/demon_passive("Ice Boost",   "+20% damage to demon's ice attacks.",          "stat", "Ice")
	DEMON_PASSIVE_DB["Ice Amp"]      = new /datum/demon_passive("Ice Amp",     "+50% damage to demon's ice attacks.",          "stat", "Ice")
	DEMON_PASSIVE_DB["Elec Boost"]   = new /datum/demon_passive("Elec Boost",  "+20% damage to demon's electric attacks.",     "stat", "Elec")
	DEMON_PASSIVE_DB["Elec Amp"]     = new /datum/demon_passive("Elec Amp",    "+50% damage to demon's electric attacks.",     "stat", "Elec")
	DEMON_PASSIVE_DB["Force Boost"]  = new /datum/demon_passive("Force Boost", "+20% damage to demon's force attacks.",        "stat", "Force")
	DEMON_PASSIVE_DB["Force Amp"]    = new /datum/demon_passive("Force Amp",   "+50% damage to demon's force attacks.",        "stat", "Force")
	DEMON_PASSIVE_DB["Crit Up"]      = new /datum/demon_passive("Crit Up",     "Demon gains +0.75 CriticalDamage.",            "stat")
	DEMON_PASSIVE_DB["Pierce"]       = new /datum/demon_passive("Pierce",      "Demon gains +9 Brutalize.",                    "stat", "Phys")

	// ===== RESISTS =====
	DEMON_PASSIVE_DB["Anti-Phys"]    = new /datum/demon_passive("Anti-Phys",   "-25% damage taken from normal attacks/queues.","resist", "Phys")
	DEMON_PASSIVE_DB["Anti-Fire"]    = new /datum/demon_passive("Anti-Fire",   "-50% damage taken from fire spells/skills.",   "resist", "Fire")
	DEMON_PASSIVE_DB["Anti-Ice"]     = new /datum/demon_passive("Anti-Ice",    "-50% damage taken from water spells/skills.",  "resist", "Ice")
	DEMON_PASSIVE_DB["Anti-Elec"]    = new /datum/demon_passive("Anti-Elec",   "-50% damage taken from lightning spells.",     "resist", "Elec")
	DEMON_PASSIVE_DB["Anti-Force"]   = new /datum/demon_passive("Anti-Force",  "-50% damage taken from wind spells/skills.",   "resist", "Force")
	DEMON_PASSIVE_DB["Anti-Curse"]   = new /datum/demon_passive("Anti-Curse",  "-50% damage taken from dark spells/skills.",   "resist", "Curse")
	DEMON_PASSIVE_DB["Anti-Almighty"]= new /datum/demon_passive("Anti-Almighty","Demon gains DebuffReversal.",                 "resist", "Almighty")
	DEMON_PASSIVE_DB["Anti-Ailment"] = new /datum/demon_passive("Anti-Ailment","Demon gains +2 DebuffResistance.",             "resist")
	DEMON_PASSIVE_DB["Anti-Most"]    = new /datum/demon_passive("Anti-Most",   "Demon End x2.",                                "resist")
	DEMON_PASSIVE_DB["Anti-All"]     = new /datum/demon_passive("Anti-All",    "All damage taken halved.",                     "resist")

	// ===== NULLS =====
	DEMON_PASSIVE_DB["Null Phys"]    = new /datum/demon_passive("Null Phys",   "-50% damage from normal attacks/queues.",      "resist", "Phys")
	DEMON_PASSIVE_DB["Null Fire"]    = new /datum/demon_passive("Null Fire",   "Fully nullifies fire damage.",                 "resist", "Fire")
	DEMON_PASSIVE_DB["Null Ice"]     = new /datum/demon_passive("Null Ice",    "Fully nullifies water damage.",                "resist", "Ice")
	DEMON_PASSIVE_DB["Null Elec"]    = new /datum/demon_passive("Null Elec",   "Fully nullifies lightning damage.",            "resist", "Elec")
	DEMON_PASSIVE_DB["Null Force"]   = new /datum/demon_passive("Null Force",  "Fully nullifies wind damage.",                 "resist", "Force")
	DEMON_PASSIVE_DB["Null Curse"]   = new /datum/demon_passive("Null Curse",  "Fully nullifies dark damage.",                 "resist", "Curse")

	// ===== DRAINS =====
	DEMON_PASSIVE_DB["Phys Drain"]   = new /datum/demon_passive("Phys Drain",  "Heals 25% / -75% damage from phys.",           "resist", "Phys")
	DEMON_PASSIVE_DB["Fire Drain"]   = new /datum/demon_passive("Fire Drain",  "Heals 25% / -75% damage from fire.",           "resist", "Fire")
	DEMON_PASSIVE_DB["Ice Drain"]    = new /datum/demon_passive("Ice Drain",   "Heals 25% / -75% damage from water.",          "resist", "Ice")
	DEMON_PASSIVE_DB["Elec Drain"]   = new /datum/demon_passive("Elec Drain",  "Heals 25% / -75% damage from lightning.",      "resist", "Elec")
	DEMON_PASSIVE_DB["Force Drain"]  = new /datum/demon_passive("Force Drain", "Heals 25% / -75% damage from wind.",           "resist", "Force")

	// ===== REPELS =====
	DEMON_PASSIVE_DB["Phys Repel"]   = new /datum/demon_passive("Phys Repel",  "Reflects 25% / -75% damage from phys.",        "resist", "Phys")
	DEMON_PASSIVE_DB["Fire Repel"]   = new /datum/demon_passive("Fire Repel",  "Reflects 25% / -75% damage from fire.",        "resist", "Fire")
	DEMON_PASSIVE_DB["Ice Repel"]    = new /datum/demon_passive("Ice Repel",   "Reflects 25% / -75% damage from water.",       "resist", "Ice")
	DEMON_PASSIVE_DB["Elec Repel"]   = new /datum/demon_passive("Elec Repel",  "Reflects 25% / -75% damage from lightning.",   "resist", "Elec")
	DEMON_PASSIVE_DB["Force Repel"]  = new /datum/demon_passive("Force Repel", "Reflects 25% / -75% damage from wind.",        "resist", "Force")

	// ===== HP/MP CAPACITY =====
	DEMON_PASSIVE_DB["Life Bonus"]   = new /datum/demon_passive("Life Bonus",  "+10% demon Max HP.",                           "stat")
	DEMON_PASSIVE_DB["Life Lift"]    = new /datum/demon_passive("Life Lift",   "Demon gains +5 LifeGeneration.",               "stat")
	DEMON_PASSIVE_DB["Life Surge"]   = new /datum/demon_passive("Life Surge",  "+30% demon Max HP.",                           "stat")
	DEMON_PASSIVE_DB["Life Stream"]  = new /datum/demon_passive("Life Stream", "+50% demon Max HP.",                           "stat")
	DEMON_PASSIVE_DB["Life Aid"]     = new /datum/demon_passive("Life Aid",    "Demon gains +2 LifeGeneration.",               "stat")
	DEMON_PASSIVE_DB["Mana Bonus"]   = new /datum/demon_passive("Mana Bonus",  "User: +10% mana cap.",                         "stat")
	DEMON_PASSIVE_DB["Mana Surge"]   = new /datum/demon_passive("Mana Surge",  "User: +30% mana cap.",                         "stat")
	DEMON_PASSIVE_DB["Mana Stream"]  = new /datum/demon_passive("Mana Stream", "User: +50% mana cap.",                         "stat")
	DEMON_PASSIVE_DB["Mana Aid"]     = new /datum/demon_passive("Mana Aid",    "User: +5 ManaGeneration.",                     "stat")

	// ===== AILMENT INFLICTORS =====
	DEMON_PASSIVE_DB["+Forget"]      = new /datum/demon_passive("+Forget",     "Demon gains +3 Disarm.",                       "ailment")
	DEMON_PASSIVE_DB["+Paralyze"]    = new /datum/demon_passive("+Paralyze",   "Demon's normal attacks inflict shock.",        "ailment")
	DEMON_PASSIVE_DB["+Poison"]      = new /datum/demon_passive("+Poison",     "Demon's normal attacks inflict poison.",       "ailment")
	DEMON_PASSIVE_DB["+Stone"]       = new /datum/demon_passive("+Stone",      "Demon's normal attacks inflict shatter.",      "ailment")

	// ===== TRIGGERS =====
	DEMON_PASSIVE_DB["Counter"]       = new /datum/demon_passive("Counter",       "Demon gains +2 Parry (tied to Counter).",    "trigger")
	DEMON_PASSIVE_DB["Retaliate"]     = new /datum/demon_passive("Retaliate",     "Demon gains +4 Parry.",                      "trigger")
	DEMON_PASSIVE_DB["Endure"]        = new /datum/demon_passive("Endure",        "Demon gains Color of Courage (UndyingRage).","trigger")
	DEMON_PASSIVE_DB["Drain Hit"]     = new /datum/demon_passive("Drain Hit",     "Demon gains +50 LifeSteal.",                 "trigger")
	DEMON_PASSIVE_DB["Avenge"]        = new /datum/demon_passive("Avenge",        "Demon gains +6 Parry.",                      "trigger")
	DEMON_PASSIVE_DB["Dodge"]         = new /datum/demon_passive("Dodge",         "Demon Def x1.5.",                            "trigger")
	DEMON_PASSIVE_DB["Watchful"]      = new /datum/demon_passive("Watchful",      "Reduces ambush chance.",                     "trigger")
	DEMON_PASSIVE_DB["Vigilant"]      = new /datum/demon_passive("Vigilant",      "Greatly reduces ambush chance.",             "trigger")
	DEMON_PASSIVE_DB["Ultimate Hit"]  = new /datum/demon_passive("Ultimate Hit",  "Demon's normal attacks inflict all almighty debuffs.","trigger")

	// ===== SPECIALS =====
	DEMON_PASSIVE_DB["Double Strike"] = new /datum/demon_passive("Double Strike", "Demon gains +5 DoubleStrike.",                              "special")
	DEMON_PASSIVE_DB["Attack All"]    = new /datum/demon_passive("Attack All",    "User: gains SweepingStrike while demon summoned.",          "special")
	DEMON_PASSIVE_DB["Quick Move"]    = new /datum/demon_passive("Quick Move",    "Demon Spd x1.5.",                                           "special")
	DEMON_PASSIVE_DB["Swift Step"]    = new /datum/demon_passive("Swift Step",    "Demon Spd x2.0.",                                           "special")
	DEMON_PASSIVE_DB["Dual Shadow"]   = new /datum/demon_passive("Dual Shadow",   "25% chance demon's skills trigger twice.",                  "special")
	DEMON_PASSIVE_DB["Victory Cry"]   = new /datum/demon_passive("Victory Cry",   "Recovers HP/Energy on kill.",                               "special")
	DEMON_PASSIVE_DB["Ares Aid"]      = new /datum/demon_passive("Ares Aid",      "Demon gains +50 CriticalChance, +0.25 CriticalDamage.",     "special")
	DEMON_PASSIVE_DB["Hero Aid"]      = new /datum/demon_passive("Hero Aid",      "Demon gains +25 CriticalChance, +0.25 CriticalDamage.",     "special")
	DEMON_PASSIVE_DB["Hero Soul"]     = new /datum/demon_passive("Hero Soul",     "User: -75% damage; demon takes 100% of that damage.",       "special")
	DEMON_PASSIVE_DB["Knight Soul"]   = new /datum/demon_passive("Knight Soul",   "User: -25% damage; demon takes 300% of that damage.",       "special")
	DEMON_PASSIVE_DB["Paladin Soul"]  = new /datum/demon_passive("Paladin Soul",  "User: -50% damage; demon takes 200% of that damage.",       "special")
	DEMON_PASSIVE_DB["Extra One"]     = new /datum/demon_passive("Extra One",     "User: gains +5 TechniqueMastery while demon summoned.",     "special")
	DEMON_PASSIVE_DB["Extra Bonus"]   = new /datum/demon_passive("Extra Bonus",   "Demon's skill cooldowns reduced by ~15% (uncapped).",       "special")
	DEMON_PASSIVE_DB["Preserve Extra"]= new /datum/demon_passive("Preserve Extra","Halves cooldown of next skill on kill.",                    "special")
	DEMON_PASSIVE_DB["Grimoire"]      = new /datum/demon_passive("Grimoire",      "Demon inflicts more statuses from its attacks.",            "special")
	DEMON_PASSIVE_DB["Moneybags"]     = new /datum/demon_passive("Moneybags",     "User: 1.25x EconomyMult while demon summoned.",             "special")
	DEMON_PASSIVE_DB["Race-O"]        = new /datum/demon_passive("Race-O",        "Boosts damage vs same race enemies.",                       "special")
	DEMON_PASSIVE_DB["Race-D"]        = new /datum/demon_passive("Race-D",        "Reduces damage from same race enemies.",                    "special")
