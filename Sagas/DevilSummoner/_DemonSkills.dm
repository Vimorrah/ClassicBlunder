...
/proc/InitDemonSkillVFX()
	...
	// ===== FIRE =====
	vfx_db["Agi"]          = new /datum/demon_skill_vfx('Icons/Effects/fevExplosion - Hellfire.dmi', "", 0, 0, 1, 5)
	vfx_db["Agidyne"]      = new /datum/demon_skill_vfx('Icons/Effects/fevExplosion - Hellfire.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Inferno"]      = new /datum/demon_skill_vfx('Icons/Effects/fevExplosion - Hellfire.dmi', "", 0, 0, 2, 6)
	vfx_db["Maragi"]       = new /datum/demon_skill_vfx('Icons/Effects/fevExplosion - Hellfire.dmi', "", 0, 0, 1, 5)
	vfx_db["Maragidyne"]   = new /datum/demon_skill_vfx('Icons/Effects/fevExplosion - Hellfire.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Fire Dance"]   = new /datum/demon_skill_vfx('Icons/Effects/fevExplosion - Hellfire.dmi', "", 0, 0, 1, 4)

	// ===== ICE =====
	vfx_db["Bufu"]         = new /datum/demon_skill_vfx('Icons/Effects/SnowBurst2.dmi', "", 0, 0, 1, 5)
	vfx_db["Bufudyne"]     = new /datum/demon_skill_vfx('Icons/Effects/SnowBurst2.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Mabufu"]       = new /datum/demon_skill_vfx('Icons/Effects/SnowBurst2.dmi', "", 0, 0, 1, 5)
	vfx_db["Mabufudyne"]   = new /datum/demon_skill_vfx('Icons/Effects/SnowBurst2.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Ice Dance"]    = new /datum/demon_skill_vfx('Icons/Effects/SnowBurst2.dmi', "", 0, 0, 1, 4)

	// ===== ELEC =====
	vfx_db["Zio"]          = new /datum/demon_skill_vfx('Icons/NSE/Hitsparks/HitElectro.dmi', "", 0, 0, 1, 5)
	vfx_db["Ziodyne"]      = new /datum/demon_skill_vfx('Icons/NSE/Hitsparks/HitElectro.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Mazio"]        = new /datum/demon_skill_vfx('Icons/NSE/Hitsparks/HitElectro.dmi', "", 0, 0, 1, 5)
	vfx_db["Maziodyne"]    = new /datum/demon_skill_vfx('Icons/NSE/Hitsparks/HitElectro.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Elec Dance"]   = new /datum/demon_skill_vfx('Icons/NSE/Hitsparks/HitElectro.dmi', "", 0, 0, 1, 4)

	// ===== FORCE =====
	vfx_db["Zan"]          = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Wind.dmi', "", 0, 0, 1, 5)
	vfx_db["Zandyne"]      = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Wind.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Mazan"]        = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Wind.dmi', "", 0, 0, 1, 5)
	vfx_db["Mazandyne"]    = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Wind.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Force Dance"]  = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Wind.dmi', "", 0, 0, 1, 4)

	// ===== ALMIGHTY =====
	vfx_db["Holy Strike"]  = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Megido"]       = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 1, 5)
	vfx_db["Megidolaon"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 1.5, 6)
	vfx_db["Judgement"]    = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 2, 6)
	vfx_db["Holy Dance"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 1, 4)

	// ===== PHYSICAL =====
	vfx_db["Power Hit"]    = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect.dmi', "", 0, 0, 1, 4)
	vfx_db["Mighty Hit"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect.dmi', "", 0, 0, 1.5, 4)
	vfx_db["Brutal Hit"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect.dmi', "", 0, 0, 2, 5)
	vfx_db["Anger Hit"]    = new /datum/demon_skill_vfx('Icons/Effects/SparkleRed.dmi', "", 0, 0, 1, 5)
	vfx_db["Piercing Hit"] = new /datum/demon_skill_vfx('Icons/Effects/Slash.dmi', "", -32, -32, 1, 4)
	vfx_db["Fatal Strike"] = new /datum/demon_skill_vfx('Icons/Effects/Slash.dmi', "", -32, -32, 1.5, 4)
	vfx_db["Assassinate"]  = new /datum/demon_skill_vfx('Icons/Effects/Slash - Black.dmi', "", -32, -32, 1.5, 5)
	vfx_db["Desperation"]  = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Ripple.dmi', "", 0, 0, 2, 6)
	vfx_db["Multi-Strike"] = new /datum/demon_skill_vfx('Icons/Effects/Claw markings.dmi', "", 0, 0, 1, 4)
	vfx_db["Deathbound"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Ripple.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Mow Down"]     = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Hassohappa"]   = new /datum/demon_skill_vfx('Icons/Effects/Slash.dmi', "", -32, -32, 1.5, 4)
	vfx_db["Berserk"]      = new /datum/demon_skill_vfx('Icons/Effects/SparkleRed.dmi', "", 0, 0, 1, 5)

	// ===== DRAIN =====
	vfx_db["Drain"]        = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Dark.dmi', "", 0, 0, 1, 5)
	vfx_db["Life Drain"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Dark.dmi', "", 0, 0, 1.5, 5)

	// ===== HEALING =====
	vfx_db["Dia"]          = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1, 5)
	vfx_db["Diarama"]      = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Diarahan"]     = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 2, 5)
	vfx_db["Media"]        = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Mediarahan"]   = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 2, 5)
	vfx_db["Prayer"]       = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 2, 6)

	// ===== REVIVAL =====
	vfx_db["Recarm"]       = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Samarecarm"]   = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 2, 6)
	vfx_db["Recarmloss"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Dark.dmi', "", 0, 0, 1.5, 5)

	// ===== SUPPORT =====
	vfx_db["Amrita"]       = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Nigayomogi"]   = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 2, 6)
	vfx_db["Shield All"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Power Charge"] = new /datum/demon_skill_vfx('Icons/Effects/SparkleRed.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Death Call"]   = new /datum/demon_skill_vfx('Icons/Effects/SparkleRed.dmi', "", 0, 0, 1, 5)
	vfx_db["Might Call"]   = new /datum/demon_skill_vfx('Icons/Effects/SparkleRed.dmi', "", 0, 0, 1, 5)
	vfx_db["Taunt"]        = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Ripple.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Makarakarn"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Tetrakarn"]    = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Divine.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Extra Cancel"] = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1, 5)

	// ===== STATUS =====
	vfx_db["Marin Karin"]  = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1, 5)
	vfx_db["Gigajama"]     = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Dark.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Sexy Gaze"]    = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1, 5)
	vfx_db["Paral Eyes"]   = new /datum/demon_skill_vfx('Icons/Effects/HitsparkStar.dmi', "", 0, 0, 1, 5)
	vfx_db["Petra Eyes"]   = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect.dmi', "", 0, 0, 1, 5)
	vfx_db["Weak Kill"]    = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect Dark.dmi', "", 0, 0, 1.5, 5)
	vfx_db["Snipe"]        = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect.dmi', "", 0, 0, 1.5, 4)
	vfx_db["Multi-Hit"]    = new /datum/demon_skill_vfx('Icons/Effects/Hit Effect.dmi', "", 0, 0, 1, 4)
